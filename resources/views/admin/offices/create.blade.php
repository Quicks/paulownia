        ...
        <div class="row">
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/admin/offices') }}" title="Back">
                        ...
                        <form method="POST" action="{{ url('/admin/offices') }}" accept-charset="UTF-8" class="form-horizontal validForm" enctype="multipart/form-data">
                            {{ csrf_field() }}
