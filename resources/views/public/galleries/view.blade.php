        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/galleries') . '?locale=' . App::getLocale() }}" title="Back">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            @foreach(config('translatable.locales') as $locale)
                                @if(App::getLocale() == $locale)
                                    @if(!empty($galleries->translate($locale)->title))
                                    ...
                                    @endif
                                    @if(!empty($galleries->translate($locale)->text))
                                        <div class="row  m-1 pt-2 border-top">
                                            <div class="col-md-3 font-weight-bold"> Text ({{$locale}})</div>
                                            <div @if($locale == 'ar') class="col-md-9 text-right"
                                                 @endif  class="col-md-9">
                                                {!! $galleries->translate($locale)->text !!}
                                            </div>
                                        </div>
                                    @endif
                                    @if(!empty($galleries->translate($locale)->keywords))
                                        <div class="row  m-1 pt-2 border-top">
