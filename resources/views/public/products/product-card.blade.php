@push('css')
    <link rel="stylesheet" href="{{asset('css/our-products.css') }}">
@endpush
    ...
    <div class="col back-ground-img m-3 position-relative">
        ...
        <img src="{{asset('/images/our-products-col-fon.png')}}" style="border-radius: 25px 25px 0 0;max-width: 100%">
        <img src="{{asset('/images/line-for-goods-in-card.png')}}" style="margin-top:-8%;max-width: 100%">
