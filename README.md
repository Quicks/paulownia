...
1. Create a folder on the computer where the project will be stored (example: paulownia).
2. In the folder "paulownia", create a folder "www".
3. Go to the folder "www" in the terminal.
4. Run: git clone http://gitlab.intita.com/Ita/Paulownia.git
5. Locate the folder "docker-files" and copy its contents to "paulownia".
 At this stage, the project structure should look like this: 
 "paulownia" -> files from folder "docker-files" and folder "www" (The entire project should be in the folder "www").
6. In the folder "paulownia" you created, where the file "docker-compose.yml" is located, run the command **docker-compose up -d**
...
10. To build the front, use the commands:
    1. npm install
    2. npm run dev
