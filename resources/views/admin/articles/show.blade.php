                        ...
                        <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr><th> Active </th><td> {{ $article->active }} </td></tr>
                                            <tr><th> Publish Date </th><td> {{ $article->publish_date }} </td></tr>
                                        </tbody>
                                    </table>
                                 </div>
                            </div>
                            ...
                            @foreach(config('translatable.locales') as $locale)
                                <div class="tab-pane fade" id="{{$locale}}" role="tabpanel"
                                    ...
                                    @isset($article->translate($locale)->title)
                                        <div class="row  m-1 pt-2 border-top">
                                            <div class="col-md-3 font-weight-bold"> Title ({{$locale}}) </div>
                                            <div @if($locale == 'ar') class="col-md-9 text-right" @endif class="col-md-9"> {{ $article->translate($locale)->title }} </div>
                                        </div>
                                    @endisset
                                    @isset($article->translate($locale)->text)
                                        <div class="row  m-1 pt-2 border-top">
                                    ...
                                    @endisset
                                    @isset($article->translate($locale)->keywords)
                                        <div class="row  m-1 pt-2 border-top">
                                            <div class="col-md-3 font-weight-bold"> Keywords ({{$locale}}) </div>
                                            <div @if($locale == 'ar') class="col-md-9 text-right" @endif class="col-md-9">
                                                {!! $article->translate($locale)->keywords !!}
                                            </div>
                                        </div>
                                    @endisset
                                </div>
