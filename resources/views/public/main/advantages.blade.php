@push('css')
    <link rel="stylesheet" href="{{ asset('css/advantages.css') }}?v7">
@endpush
...
<div class="advantages">
    <div class="row text-center mx-auto advantages-width">
        ...
        <div class="col mx-auto adv-scale animated" style="max-width: 160px">
            <img data-src="{{asset('images/adv-sales.png')}}" class="pb-3 lazyload">
            <p class="advantages-text">
                More than 10 years in the market
            </p>
        </div>
        <div class="col mx-auto adv-scale animated" style="max-width: 177px">
            <img data-src="{{asset('images/adv-certificate.png')}}" class="pb-3 lazyload">
            <p class="advantages-text">
                Certified seedlings
            </p>
        </div>
        <div class="col mx-auto adv-scale animated" style="max-width: 280px">
        ...
        <div class="col mx-auto adv-scale animated" style="max-width: 230px">
            <img data-src="{{asset('images/adv-conversation.png')}}" class="pb-3 lazyload">
            <p class="advantages-text">
                Individual approach to each client
            </p>
        </div>
        <div class="col mx-auto adv-scale animated" style="max-width: 140px">
