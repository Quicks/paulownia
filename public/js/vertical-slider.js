var Carousel = {
    width: 280,     // Images are forced into a width of this many pixels.
...
window.onload = function () {
    ...
    var carousel = Carousel.carousel = document.getElementById('carousel'),
        images = carousel.getElementsByTagName('span'),
    ...
    carousel.style.height = Carousel.numVisible * Carousel.rowHeight +30+'px';
    carousel.style.visibility = 'visible';
    var wrapper = Carousel.wrapper = document.createElement('div');
    wrapper.id = 'carouselWrapper';
    wrapper.style.width = carousel.offsetWidth + 30+'px';
    wrapper.style.height = carousel.offsetHeight + 30+'px';
