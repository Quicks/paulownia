...
<div class="wood-slider-container container-wrap">
    ...
    <div class="row mt-5">
        <div class="col-12">
            <div class="d-flex justify-content-center align-items-center plant-slider-wrap">
                ...
                <div class="slider-wrap wood-slider"></div>
    ...
    <script>
        ...
        $.ajax({
            ...
            data: {
                ...
                initSlider('wood-slider', sliderConf);
                $.parseHTML(response).map(function(element, index) {
                    if(index % 2 === 0) {
                        $('.wood-slider').slick('slickAdd', `<div class="slide-initial">${element.outerHTML}</div>`);
                    }
                });
            }
        })
