<div class="header pb-1 row">
    <div class="col-xl-2 col-md-6 col-sm-6 d-flex align-items-end mt-md-3 mt-sm-3 mx-auto" style="max-width: 140px">
        <a href="{{route('main')}}">
            ...
            <div id="all-pages" class="navbar-collapse collapse row">
                ...
                <div class="col-xl-2">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item ml-xl-3">
                            <a href="#"><img width="20px" height="20px" src="{{asset('images/favorite-heart-button.svg')}}"></a>
                        </li>
                    </ul>
                </div>
            </div>
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#all-pages"
